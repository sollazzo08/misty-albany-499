...
function _FrontTOF(data) {
    ...
    misty.Stop(); //stops the skill entirely 
...
/*
  The idea is to regeister an event for misty 
  THen you can add property tests to the event
    - such as get her distance 
    - such as get her sensor poistion
